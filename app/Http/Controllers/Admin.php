...
use App\Http\Requests\createReq;
...
class Admin extends Controller
{
    ...
    public function __construct(){
        ...
        foreach ($projects as $key => $loop) {
            $dh = Carbon::now()->diff(new Carbon($loop->sampai))->format('%d');
            $dm = Carbon::now()->diff(new Carbon($loop->sampai))->format('%m');
    ...
    public function index()
    {
        ...
        $data['alert'] = \DB::table('alerts')
                   ...
                   ->orderBy('sk_bln','asc')->get();
                        return view('Admin/dashboard',$data,compact('yourFirstChart'));
    }
    ...
    public function createProj() //Redirect pada halaman pembuatan project baru
    {
        ...
        $witel = witel::where('activa','Aktif')->lists('witel','witel');    
        $tender = jenter::where('activa','Aktif')->lists('jenis','jenis');
        return view('Admin/Project/insertDP',compact('tender'),compact('witel'));
    }
    ...
    public function showProj()
    {
        ...
        return view('Admin/Project/showdataDP',$data);
    }

    public function listDoc()
    {
        $data['project'] = \DB::table('docs')
                ->join('masters','docs.idproj','=','masters.id')
                ->select('docs.*','masters.nama_proj','masters.id AS idpr')
                ->get();
    ...
    public function storeProj(Request $request) // Mengirim Data Project pada DBase
    {
       ...
       $data = $request->all();
       $dh = Carbon::now()->diffInDays(new Carbon($sampai));
       $dm = Carbon::now()->diffInMonths(new Carbon($sampai));
       $data['sk_hr'] = $dh;
       $data['sk_bln'] = $dm;
       $data['mulai'] = $mulai;
       $data['sampai'] = $sampai;
    ...
    public function editProject($id) //
    {
       ...
       $witel = witel::lists('witel','witel');    
        ...
        return view('Admin\Project\editDP',compact('project','tender','witel'));
    }
    ...
    public function deleteProject($id)
    {
        $project = master::find($id);
        $project->delete();
        return redirect('Admin/proj/show');
    }
    ...
    public function insertDoc($id)
    {
        ...
        if(!is_null($doc))
        {
            Session::flash('error', 'Dokumen pada project '.$id.' sudah diinput');
            return redirect()->back();
        }

        return view('Admin/Project/uploaddoc2',$data); 
    }

    public function editDoc($id,$idpr)
    {
        $data['project'] = master::find($idpr);
        $data['doc'] = doc::find($id);
         return view('Admin/Project/uploaddoc',$data);
    }
    ...
    public function updateDoc($id,Request $request)
    {
            ...
            $doc->update($data);
            return redirect('Admin/proj/listdoc');
    }
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public function showList()
    {
        ...
        $data['project'] = master::all();
        return view('Admin/Agenda/showList',$data);
    } 
    ...
    public function storeAgenda(Request $request)
    {
       ...
       //var_dump($data);
        ...
        agenda::create($data);
        return redirect('Admin/agenda/show');
    }
    ...
    public function showAgenda()
    {
        ...
        return view('Admin/Agenda/showagend',$data);
    ...
    public function editAgenda($ida,$idp)
    {
        ...
        return view('Admin/Agenda/editAg',$data);
    }
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    {
        return view('Admin/User/insertDU');
    }

    public function showUser()
    {
        $data['user'] = akun::all();
        return view('Admin/User/showdataDU',$data);
    }

     public function storeReg(createReq $request)
    {
        $input = $request->all();
        $plain = "1234567";
        $input['plain'] = $plain;
    ...
    {
        $data['user']= akun::find($id);
        return view('Admin/User/editDU',$data);
    }
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    {
        return view('Admin/Tender/inserttender');
    }

    public function showTender()
    {
        $data['tender'] = jenter::all();
        return view('Admin/Tender/showtender',$data);
    }

    public function editTender($id)
    {
        $data['tender'] = jenter::find($id);
        return view('Admin/Tender/edittender',$data);
    }
    ...
    public function updateTender(Request $request,$id)
    {
       ...
       $tender->update($data);
       return redirect('Admin/tender/show');
    }
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    {
        return view('Admin/witel/insertwitel');
    }

    public function showWitel()
    {
        $data['witel'] = witel::all();
        return view('Admin/Witel/showwitel',$data);
    }
    ...
    {
        $data['witel'] = witel::find($id);
        return view('Admin/Witel/editwitel',$data);
    }
    ...
    public function deleteWitel($id)
    {
        $witel = witel::find($id);
        $witel->delete();
        return redirect('Admin/witel/show');
    }
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    {
        return view('Admin/Project/uploadExproj');
    }

    public function uploadExcelagen()
    {
        return view('Admin/Agenda/uploadExagen');
    }
    ...
    public function storeExcelagen(Request $request) {
        ...
        if($request->hasFile('excel') && ($extension == "xls" || $extension == "xlsx"))
        {
            ...
            return redirect('Admin/agenda/excelAgen');
        }
        else
        {
    ...
    public function updateExagen($result,$r)
    {
    ...
    public function toExagen()
    {
        ...
        \Excel::create('Data Agenda',function($excel) use ($agenda)
        {
            $excel->sheet('data agenda',function($sheet) use ($agenda)
            {
                $row=1;
                $sheet->row($row,array(
                    'NO','PROJECT ID','NAMA PROJECT','NO P1','TGL P1','NO P2','TGL P2','NO P3','TGL P3','NO P4','TGL P4','NO P5','TGL P5','NO P6','TGL P6','NO P7','TGL P7','NO P8','TGL P8','NO KL','TGL KL'));
                $no=1;
...
//Agenda
    public function insertAgenda($id)
    {
        ...
        {
            $data['project'] = master::find($id);
            return view('Admin/Agenda/insertAg',$data);
        }
        elseif(!is_null($res))
        {
...
//Alert
    public function insertAlert($id,$prid)
    {
        ...
        $alerto->delete();
        return redirect('Admin/proj/insert');
    }
    ...
    public function toInteger($str)
    {
        ...
        $dato = explode(".", $date);
        unset($dato[0]);
        $datoap = array_values($dato);
        $finalarr = implode($datoap);
        return $finalarr;
    }
