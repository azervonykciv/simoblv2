      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="{{ url('Admin/agenda/show') }}"><i class="fa fa-circle-o"></i>Masukkan Agenda Project</a></li>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>{{ $p->pelanggan}}</td>
                  <td>{{ $p->nama_proj}}</td>
                  <td>{!! link_to('Admin/agenda/insert/'.$p->id,'Edit',['class'=>'btn btn-primary']) !!}
                  </td>
                </tr>
                 @endforeach
                </tbody>
