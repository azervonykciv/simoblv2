      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="{{ url('Admin/tender/show') }}"><i class="fa fa-circle-o"></i>Data Tender</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Data Induk Lain-lain</a></li>
        <li class="active">Data Tender</li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            {!! Form::model($tender,array('url'=>'Admin/tender/'.$tender->id,'method'=>'patch'))!!}
            <form role="form">
              <div class="box-body">
              <div class="form-group">
                  <label>ID Tender</label>
                ...
                <div class="form-group">
                  <label>Status</label>
                  {!! Form::select('activa',array(''=>'Pilih Status','Aktif'=>'Aktif','Tidak Aktif'=>'Tidak Aktif'),null) !!}
                </div>
              </div>
              <!-- /.box-body -->
