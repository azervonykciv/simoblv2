       ...
       <div class="col-xs-12">
         ...
         @if(Session::has('error'))
          ...
          @endif
            ...
            <!-- /.box-header -->
            <!-- form start -->
            {!! Form::model($doc,array('url'=>'Admin/proj/editdocs/'.$doc->id,'method'=>'patch','files'=>'true'))!!}
            <form role="form">
              <div class="box-body">
              <table class="table table-bordered table-striped">
                ...
                <td><strong>{{ $doc->p1 }}</strong></td>
                <td><strong>{{ $doc->stat_p1 }}</strong></td>
                </tr>
                 <tr>
                  <td>P2</td>
                  <td><div class="form-group">
                ...
                <td><strong>{{ $doc->p2 }}</strong></td>
                <td><strong>{{ $doc->stat_p2 }}</strong></td>
                </tr>
                 <tr>
                  <td>P3</td>
                  <td><div class="form-group">
                ...
                <td><strong>{{ $doc->p3 }}</strong></td>
                <td><strong>{{ $doc->stat_p3 }}</strong></td>
                </tr>
                 <tr>
                  <td>P4</td>
                  <td><div class="form-group">
                ...
                <td><strong>{{ $doc->p4 }}</strong></td>
                <td><strong>{{ $doc->stat_p4 }}</strong></td>
                </tr>
                 <tr>
                  <td>P5</td>
                  <td><div class="form-group">
                ...
                <td><strong>{{ $doc->p5 }}</strong></td>
                <td><strong>{{ $doc->stat_p5 }}</strong></td>
                </tr>
                 <tr>
                  <td>P6</td>
                  <td><div class="form-group">
                ...
                <td><strong>{{ $doc->p6 }}</strong></td>
                <td><strong>{{ $doc->stat_p6 }}</strong></td>
                </tr>
                 <tr>
                  <td>P7</td>
                  <td><div class="form-group">
                ...
                <td><strong>{{ $doc->p7 }}</strong></td>
                <td><strong>{{ $doc->stat_p7 }}</strong></td>
                </tr>
                <tr>
                  <td>P8</td>
                  <td><div class="form-group">
                ...
                <td><strong>{{ $doc->p8 }}</strong></td>
                <td><strong>{{ $doc->stat_p8 }}</strong></td>
                </tr>
                </tbody>
              </table>
