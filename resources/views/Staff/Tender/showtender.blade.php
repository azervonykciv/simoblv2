      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="{{ url('Staff/tender/show') }}"><i class="fa fa-circle-o"></i>Data Tender</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>{{ $u->jenis }}</td>
                  <td>{{ $u->activa }}</td>
                  <td>{!! link_to('Admin/tender/'.$u->id.'/edit','Edit',['class'=>'btn waves-effect waves-light indigo']) !!}
                                {!! Form::open(array('method'=>'delete','url'=>'Admin/tender/'.$u->id)) !!}
