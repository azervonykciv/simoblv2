      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="{{ url('Staff/tender/insert') }}"><i class="fa fa-circle-o"></i>Data Tender</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            {!! Form::open(array('route'=>'post-tender')) !!}
            <form role="form">
              <div class="box-body">
                <div class="form-group">
                  <label>Jenis Tender</label>
                  <input type="text" name="jenis" class="form-control" placeholder="jenis Tender">
                </div>
                <div class="form-group">
                  <label>Status</label>
